...
class TestView(TestCase):
   ...
   def setUp(self):
      ...
      self.post=PostModel.objects.create(title="test",author=self.authorObj,slug="test",date="2026-01-07",excerpt="test excerpt test excerpt test excerpt",ingredients="Test ingredient",prepare="test prepare",image="../../../spaghetti.webp")

      self.post.tags.add(self.tagObj)
